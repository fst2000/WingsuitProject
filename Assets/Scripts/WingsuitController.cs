...
public class WingsuitController : MonoBehaviour
{
    ...
    Wing wingLeft = new Wing(Vector3.back, new Vector3(-0.5f, 1, 0), 1f, 0.5f);
    Wing wingRight = new Wing(Vector3.back, new Vector3(0.5f, 1, 0), 1f, 0.5f);
    Wing wingBack = new Wing(Vector3.back, new Vector3(0, 0, 0), 0.5f, 1f);
